  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 justify-items-center items-center mt-4 mx-4">
        <img src={Item1} alt="Category 1" className="w-20 sm:w-24 md:w-48" />
        <img src={Item2} alt="Category 2" className="w-20 sm:w-24 md:w-48" />
        <img src={Item3} alt="Category 3" className="w-20 sm:w-24 md:w-48" />
        <img src={Item4} alt="Category 4" className="w-20 sm:w-24 md:w-48" />
        <img src={Item5} alt="Category 5" className="w-20 sm:w-24 md:w-48" />
        <img src={Item6} alt="Category 6" className="w-20 sm:w-24 md:w-48" />
      </div>
    </>
  );
}
